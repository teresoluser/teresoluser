...
<head>
    <meta charset="UTF-8">
    <title>rest-json-quickstart - 1.0.0-SNAPSHOT</title>
    <style>
        h1, h2, h3, h4, h5, h6 {
...
<div class="container">
    <div class="left-column">
        ...
        <ul>
            ...
            <p><code>@Path: <a href="/fruits" class="path-link" target="_blank">/fruits</a></code></p>
    ...
    <div class="right-column">
        <div class="right-section">
            ...
            <ul>
                ...
                <li>ArtifactId: <code>rest-json-quickstart</code></li>
